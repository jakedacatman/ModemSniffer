...
function locate( _nTimeout, _bDebug )
    ...
    while true do
        ...
        if e == "modem_message" then
            ...
            if sChannel == 6969 then
                -- Received the correct message from the correct modem: use it to determine position
                if type(tMessage) == "table" and #tMessage == 3 and tonumber(tMessage[1]) and tonumber(tMessage[2]) and tonumber(tMessage[3]) and tonumber(tMessage[4]) then
